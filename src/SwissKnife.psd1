...
Copyright = '(c) 2019 Lineup. All rights reserved.'
...
FunctionsToExport = 'Add-MemberOrSetValue', 'Get-Enum', 'Get-UrlFilename', 
               'New-ScheduledTaskFolder', 'Measure-Count', 'Measure-CountWhere', 
               'Invoke-ElevatedScript', 'Invoke-ErrorProne', 'Get-FilesFromZip', 
